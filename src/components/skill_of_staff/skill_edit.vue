...
export default ({
  ...
  methods:{
    checklogin: function(){
      console.log('ss:',this.$route.params.id);
        axios.get('https://backend-v01.herokuapp.com/api/editSkill/'+this.$route.params.id,)
        .then( (res) => {
    ...
    update: function(){      
      ...
      axios.post('https://backend-v01.herokuapp.com/api/updateSkill/'+this.$route.params.id,
               this.skillForm
        )
        .then( (res) => {
